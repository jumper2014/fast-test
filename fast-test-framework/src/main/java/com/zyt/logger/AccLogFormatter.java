...
public class AccLogFormatter {
    ...
    AccLogFormatter(String alarmID, String requestType, String errorCode, String errorMsg, String... reserved) {
    ...
    public static class AlarmLogFormatterBuilder {
        ...
        public AccLogFormatter build() {
            return new AccLogFormatter(this.alarmID, this.requestType, this.errorCode, this.errorMsg, this.reserved);
        }
