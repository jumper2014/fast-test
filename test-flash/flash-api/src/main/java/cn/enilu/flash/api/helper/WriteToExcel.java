...
//            System.out.println("Row: " + String.valueOf(i));
    ...
    public static HSSFCellStyle getHeadStyle(HSSFCellStyle styleHead, HSSFFont fontHead) {
        // 水平居中
        styleHead.setAlignment(CENTER);
        // 垂直居中
        styleHead.setVerticalAlignment(CENTER);
        // 设置标题背景色
        styleHead.setFillPattern(SOLID_FOREGROUND);
//        styleHead.setFillForegroundColor(IndexedColors.LIME.getIndex());// 绿色
        ...
        // 设置四周边框
        styleHead.setBorderBottom(THIN);// 下边框
        styleHead.setBorderLeft(THIN);// 左边框
        styleHead.setBorderTop(THIN);// 上边框
        styleHead.setBorderRight(THIN);// 右边框
